...
data = json.load(codecs.open('C:/Users/jasonyip184/Desktop/cheetah-backup/raw_modules_data.json', 'r', 'utf-8-sig'))
keys = data[0].keys()
...
with open('../src/data/old_course_data.json', 'w') as outfile:
